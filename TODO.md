...
- Keep runtime logic in `` and packaging/release logic outside it.
...
- Status: completed through the `dipsy_dolphin/ui/`, `dipsy_dolphin/core/`, `dipsy_dolphin/storage/`, `dipsy_dolphin/audio/`, `dipsy_dolphin/llm/`, and `dipsy_dolphin/actions/` package layout.
