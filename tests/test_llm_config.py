...
from dipsy_dolphin.llm.config import discover_model_bundle


def test_discover_model_bundle_prefers_env_model_dir(monkeypatch, tmp_path: Path) -> None:
    ...
    resolved = discover_model_bundle()
